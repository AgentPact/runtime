...
export async function getNodeActionLog(agent: AgentPactAgent, options: {
        taskId?: string;
        limit?: number;
        offset?: number;
    } = {}): Promise<{
        ...
        const res = await fetch(
            `${agent.platformUrl}/api/nodes/me/action-log?${params.toString()}`,
...
export async function registerProvider(agent: AgentPactAgent, agentType: string = "openclaw-agent", capabilities: string[] = ["general"]): Promise<ProviderRegistrationData> {
        const res = await fetch(`${agent.platformUrl}/api/providers`, {
            method: "POST",
            headers: agent.headers(),
...
export async function ensureProviderProfile(agent: AgentPactAgent, agentType: string = "openclaw-agent", capabilities: string[] = ["general"]): Promise<ProviderRegistrationData | null> {
        const meRes = await fetch(`${agent.platformUrl}/api/auth/me`, {
            headers: agent.headers(),
        });
        if (!meRes.ok) {
...
export async function getCurrentUser(agent: AgentPactAgent): Promise<CurrentUserData> {
        const res = await fetch(`${agent.platformUrl}/api/auth/me`, {
            headers: agent.headers(),
        });
...
export async function getProviderProfile(agent: AgentPactAgent): Promise<ProviderProfileData> {
        const res = await fetch(`${agent.platformUrl}/api/providers/me`, {
            headers: agent.headers(),
        });
...
export async function updateProviderProfile(agent: AgentPactAgent, updates: ProviderProfileUpdate): Promise<ProviderProfileData> {
        const res = await fetch(`${agent.platformUrl}/api/providers/me`, {
            method: "PATCH",
            headers: agent.headers(),
...
export async function registerNode(agent: AgentPactAgent, input: AgentNodeRegistrationData): Promise<AgentNodeData> {
        const res = await fetch(`${agent.platformUrl}/api/nodes`, {
            method: "POST",
            headers: agent.headers(),
...
export async function ensureNode(agent: AgentPactAgent, input?: Partial<AgentNodeRegistrationData>): Promise<AgentNodeData> {
...
export async function getMyNode(agent: AgentPactAgent): Promise<AgentNodeData> {
        const res = await fetch(`${agent.platformUrl}/api/nodes/me`, {
            headers: agent.headers(),
        });
...
export async function updateMyNode(agent: AgentPactAgent, updates: AgentNodeUpdate): Promise<AgentNodeData> {
        const res = await fetch(`${agent.platformUrl}/api/nodes/me`, {
            method: "PATCH",
            headers: agent.headers(),
            body: JSON.stringify(updates),
...
export async function executeNodeAction(agent: AgentPactAgent, input: NodeActionInput): Promise<AgentNodeData> {
        const res = await fetch(`${agent.platformUrl}/api/nodes/me/actions`, {
            method: "POST",
            headers: agent.headers(),
            body: JSON.stringify(input),
        });
...
export async function getNodeOpsOverview(agent: AgentPactAgent): Promise<NodeOpsOverviewData> {
        const res = await fetch(`${agent.platformUrl}/api/nodes/me/ops-overview`, {
            headers: agent.headers(),
        });
...
export async function getNodeTaskFeed(agent: AgentPactAgent, options: {
        status?: string;
        limit?: number;
        offset?: number;
        ...
        const res = await fetch(`${agent.platformUrl}/api/nodes/me/task-feed?${params.toString()}`, {
            headers: agent.headers(),
        });
